                            ...
                            <tr v-for="asset in paginatedAssets" :key="asset.id">
                                ...
                                <td>
                                    <div class="action-cell">
                                        <button class="btn-action text-warning yellow-600" data-tooltip="Chỉnh sửa" v-permission="'collateral.detail'" @click="openAssetsDetailModal(asset.id)"><font-awesome-icon
