        ...
        <div class="group-function">
            <div class="search">
                <div class="search-input">
                    ...
                    <input v-model="search" type="text" id="search" placeholder="Tìm kiếm theo tên, SĐT">
                </div>
                <div class="filter">
                        ...
                        <tr v-for="loan, index in paginated" :key="loan.id">
                            ...
                            <td>
                                <div class="action-cell">
                                    <button class="btn-action text-success" data-tooltip="Đóng lãi" v-permission="'repayment.interest_payment'" @click="openInterestModal(loan.id)">
                                        <font-awesome-icon icon="coins" />
                                    </button>
                                    <button class="btn-action text-success" data-tooltip="Trả bớt gốc" v-permission="'repayment.reduce_principal'" @click="openReducePrincipalModal(loan.id)">
                                        <font-awesome-icon icon="money-bill-wave" />
                                    </button>
                                    <button class="btn-action text-success" data-tooltip="Tất toán" v-permission="'repayment.final_settlement'" @click="openFinalModal(loan.id)">
