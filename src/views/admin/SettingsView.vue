...
<template>
  <div class="settings-page">
    ...
    <div v-if="activeTab === 'contracts'" class="tab-content">
      ...
      <div class="template-grid-note">
        <div class="template-note">
          <div class="note-content">
            <p>LƯU Ý: Phải thêm các trường sau đây vào mẫu Hợp Đồng, Mẫu Biên Nhận để có thể sử dụng được:</p>
            <ul>
              ...
              <li>{Tien_vay_bang_chu} : Số tiền vay bằng chữ</li>
        ...
        <div class="template-note">
          <div class="note-content">
            <p>LƯU Ý: Phải thêm các trường sau đây vào mẫu Phiếu Thu để có thể sử dụng được:</p>
            <ul>
              <li>{Tien_thu} : Số tiền thu</li>
              <li>{Tien_thu_bang_chu} : Số tiền thu bằng chữ</li>
              <li>{Tien_thu_phi} : Số tiền thu phí</li>
              <li>{Tien_thu_phi_bang_chu} : Số tiền thu phí bằng chữ</li>
              <li>{Ten_KH} : Tên khách hàng</li>
              <li>{SDT_KH} : Số điện thoại khách hàng</li>
              <li>{Dia_chi_KH} : Địa chỉ khách hàng</li>
              <li>{Ngay} : Ngày</li>
